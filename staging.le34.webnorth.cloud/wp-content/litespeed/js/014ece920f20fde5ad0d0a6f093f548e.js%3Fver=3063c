...
(function() {
    if (!document.getElementById('le34-team-css')) {
        ...
        link.href = 'https://raw.githack.com/NiklasLE34/LE34_LocalOverrides_/master/staging.le34.webnorth.cloud/wp-content/litespeed/css/le34style.css?v=' + Math.random();
...
(function(factory) {
    ...
    var factoryOutput = ( () => {
        ...
        var K = 0
          ...
          , I = l => l.replace(/\D/g, "")
          , S = (l="") => l.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase()
          , M = l => {
            let t = I(l);
            if (t.charAt(0) === "1") {
                let e = t.substr(1, 3);
          ...
          , w = class {
            ...
            _f() {
                ...
                let {allowDropdown: t, separateDialCode: e, showFlags: i, containerClass: n, hiddenInput: s, dropdownContainer: o, fixDropdownWidth: u, useFullscreenPopup: a, countrySearch: d, i18n: c} = this.d
                  , m = "forminator-iti-input iti";
                t && (m += " iti--allow-dropdown"),
                i && (m += " iti--show-flags"),
                n && (m += ` ${n}`),
                a || (m += " iti--inline-dropdown");
                let h = p("div", {
                    class: m
                });
                ...
                t || i || e) {
                    ...
                    t) {
                        let y = u ? "" : "iti--flexible-dropdown-width";
                        if (this.dropdownContent = p("div", {
                            id: `iti-${this.id}__dropdown-content`,
                            class: `iti__dropdown-content iti__hide ${y}`
                        }),
                        d && (this.searchInput = p("input", {
                            type: "text",
                        ...
                        d && this._p4(),
                        o) {
                            let C = "forminator-iti-input iti iti--container";
                            a ? C += " iti--fullscreen-popup" : C += " iti--inline-dropdown",
                            this.dropdown = p("div", {
                                class: C
                            }),
                ...
                s) {
                    let g = this.a.getAttribute("name") || ""
                      , y = s(g);
                    if (y.phone) {
                        let C = this.a.form?.querySelector(`input[name="${y.phone}"]`);
                        C ? this.hiddenInput = C : (this.hiddenInput = p("input", {
                            type: "hidden",
                            name: y.phone
                        }),
                    ...
                    if (y.country) {
                        let C = this.a.form?.querySelector(`input[name="${y.country}"]`);
                        C ? this.hiddenInputCountry = C : (this.hiddenInputCountry = p("input", {
                            type: "hidden",
                            name: y.country
                        }),
            ...
            _h(t=!1) {
                let e = this.a.getAttribute("value")
                  ...
                  , o = this._5(s)
                  , u = M(s)
                  , {initialCountry: a, geoIpLookup: d} = this.d
                  , c = a === "auto" && d;
                if (o && !u)
                    this._v(s);
                else if (!c || t) {
                    let m = a ? a.toLowerCase() : "";
            ...
            _i3() {
                ...
                ,
                r.documentReady() ? this._handlePageLoad() : window.addEventListener("load", this._handlePageLoad)) : this.i0(),
            ...
            _i4() {
                ...
                typeof this.d.geoIpLookup == "function" && this.d.geoIpLookup( (t="") => {
                    ...
                    setTimeout( () => v("handleAutoCountry"))) : (this._h(!0),
                    v("rejectAutoCountryPromise"))
                }
                , () => {
                    this._h(!0),
                    v("rejectAutoCountryPromise")
                ...
                this._a12 = a => {
                    if (this.isAndroid && a?.data === "+" && i && s && o) {
                        let h = this.a.selectionStart || 0
                          ...
                          , y = this.a.value.substring(h);
                        this.a.value = g + y,
                        this._nWithPlus();
                        return
                    }
                    this._v(this.a.value) && this._8();
                    let d = a?.data && /[^+0-9]/.test(a.data)
                      , c = a?.inputType === "insertFromPaste" && this.a.value;
                    d || c && !t ? u = !0 : /[^+0-9]/.test(this.a.value) || (u = !1);
                    let m = a?.detail && a.detail.isSetNumber && !n;
                    if (e && !u && !m) {
                        let h = this.a.selectionStart || 0
                          , y = this.a.value.substring(0, h).replace(/[^+0-9]/g, "").length
                          , C = a?.inputType === "deleteContentForward"
                          , b = this._9()
                          , _ = V(y, b, h, C);
                        this.a.value = b,
                        this.a.setSelectionRange(_, _)
                    }
                }
                ,
                this.a.addEventListener("input", this._a12),
                (t || i) && (this._handleKeydownEvent = a => {
                    if (a.key && a.key.length === 1 && !a.altKey && !a.ctrlKey && !a.metaKey) {
                        ...
                        if (t) {
                            let d = this.a.value
                              , m = !(d.charAt(0) === "+") && this.a.selectionStart === 0 && a.key === "+"
                              , h = /^[0-9]$/.test(a.key)
                              , g = i ? h : m || h
                              , y = d.slice(0, this.a.selectionStart) + a.key + d.slice(this.a.selectionEnd)
                              , C = this._6(y)
                              , b = this.s.dialCode || ""
                              , _ = C.startsWith(`+${b}`) ? C.slice(b.length + 1).replace(/\D/g, "") : r.utils.getCoreNumber(C, this.s.iso2)
                              , k = this.maxCoreNumberLength && _.length > this.maxCoreNumberLength;
            ...
            _p3(t, e=!1) {
                ...
                for (let s = 0; s < this.p.length; s++) {
                    let o = this.p[s]
                      , u = S(o.name)
                      , a = o.name.split(/[^a-zA-ZÀ-ÿа-яА-Я]/).map(c => c[0]).join("").toLowerCase()
                      , d = `+${o.dialCode}`;
                    if (e || u.includes(n) || d.includes(n) || o.iso2.includes(n) || a.includes(n)) {
                        let c = o.nodeById[this.id];
            ...
            _getCountryFromNumber(t) {
                ...
                if (o) {
                    let a = I(o)
                      , d = this.q[a];
                    if (!n && this.j && d.includes(this.j))
                        return this.j;
                    let c = n && d.includes(n) && (u.length === a.length || !this.s.areaCodes);
                    if (!(s === "1" && M(u)) && !c) {
                ...
                if (t && r.utils)
                    if (n) {
                        let s = r.utils.numberType[e]
                          ...
                          , u = o;
                        for (; r.utils.isPossibleNumber(o, n, i); )
                            u = o,
                            o += "0";
            ...
            _6(t) {
                let e = t || this.a.value.trim(), {dialCode: i} = this.s, n, s = I(e);
                return this.d.separateDialCode && e.charAt(0) !== "+" && i && s ? n = `+${i}` : n = "",
                n + e
            }
            _7(t) {
                let e = t;
          ...
          , W = l => {
            if (!r.utils && !r.startedLoadingUtilsScript) {
                ...
                return r.startedLoadingUtilsScript = !0,
                t.then(e => {
                    let i = e?.default;
                    ...
                    throw v("rejectUtilsScriptPromise", e),
                    e
                }
                )
            }
